...
const HomePage = () => {
    ...
    return (
        <Layout title={"All Products - Best offers "}>
            <div className="all_product-main-box-full-product">
            <div className="container-fluid row mt-3 justify-content-center Pro_main_page">
                <div className="col-md-2 Filter_By_Category">
                    ...
                    <div className="d-flex flex-column">
                        <button
                            className="all-btn-style reset-btn"
